                    ...
                    <form action="">
                            ...
                            <div class="col-xs-12 col-md-6">
                                ...
                                <div class="row mb-3">
                                    <div class="col-xs-12 col-md-6 ">
                                        ...
                                        <select name="suc" id="" class="form-control">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-xs-12 col-md-3">
                                        ...
                                        <select name="renta_tipo" id="" class="form-control">
                                    ...
                                    <div class="col-xs-12 col-md-3">
                                        <label for="">&nbsp;</label>
                                        <input type="number" class="form-control" name="renta"
                                ...
                                <div class="row mb-3">
                                    <div class="col-xs-12 col-md-6">
                                        ...
                                        <input type="number" name="meses_cotizados" class="form-control">
                                    </div>
                                    <div class="col-xs-12 col-md-6">
                                        <label for="">Zona extrema</label>
                                        <input type="number" step="any" class="form-control" name="zona_extrema">
                                    </div>
                                </div>
                                <div class="row mb-3">
                            ...
                            <div class="col-xs-12 col-md-6">
                                ...
                                <div class="row mb-3">
                                    <div class="col-xs-12 col-md-6">
                                        ...
                                        <select name="gratificacion" id="" class="form-control">
                                    ...
                                    <div class="col-xs-12 col-md-6">
                                        ...
                                        <input type="number" name="factor_he" class="form-control"
                                ...
                                <div class="row mb-3">
                                    <div class="col-xs-12 col-md-6">
                                        ...
                                        <input type="number" name="colacion" class="form-control">
                                    </div>
                                    <div class="col-xs-12 col-md-6">
                                        <label for="">Movilización</label>
                                        <input type="number" name="movilizacion" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-xs-12 col-md-12">
                                        <label for="">Dias Vacaciones/Año</label>
                                        <input type="number" name="dias_vacaciones" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-xs-12">
                                ...
                                <select name="fecha_causa" id="" class="form-control">
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-md-6">
                                ...
                                <input type="date" name="fecha_finiquito" class="form-control">
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <label for="">Monto Aviso</label>
                                <input type="number" name="monto_aviso" class="form-control" placeholder="ingrese monto ">
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-md-6">
                                ...
                                <input type="number" class="form-control" name="monto_indemnizacion" placeholder="ingrese indemnizacion">
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <label for="">Monto Vacaciones</label>
                                <input type="text" name="monto_vacaciones" class="form-control" placeholder="Ingrese monto">
                            </div>
                        </div>
