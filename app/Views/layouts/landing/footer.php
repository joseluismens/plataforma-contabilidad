									...
									<div class="card mb-0 px-0">
										<div class="card-body px-0">
												...
												<div class="row">
													...
													<div class="col-lg-2 col-sm-6 col-md-4">
														...
														<ul class="list-unstyled mb-5 mb-lg-0">
															...
															<li><a href="<?php echo base_url('alerts'); ?>">Elements</a></li>
															<li><a href="<?php echo base_url('form-elements'); ?>">Forms</a></li>
															<li><a href="<?php echo base_url('chart-echart'); ?>">Charts</a></li>
															<li><a href="<?php echo base_url('datatable'); ?>">Tables</a></li>
															<li><a href="<?php echo base_url('file-attachments'); ?>">Other Pages</a></li>
														</ul>
													</div>
													<div class="col-lg-2 col-sm-6 col-md-4">
														...
														<ul class="list-unstyled mb-5 mb-lg-0">
															...
															<li><a href="<?php echo base_url('terms'); ?>">Terms and Services</a></li>	
														</ul>
													</div>
											...
											<footer class="main-footer px-0 pb-0">
												<div class="row ">
													<div class="col-xl-8 col-lg-12 col-md-12 footer1">GPSCONTROL.CL
													</div>
