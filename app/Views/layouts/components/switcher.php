                        ...
                        <div class="predefined_styles">
                            <div class="swichermainleft text-center">
                                <div class="p-3 d-grid gap-2">
                                    <a href="https://codeigniter.spruko.com/noa/noa/index" class="btn ripple btn-primary mt-0">View Demo</a>
                                        ...
                                        <div class="switch-toggle">
                                            ...
                                            <div class="mt-1">
                                                <a class="bg-img1" href="javascript:void(0);" onclick="bgImage(this)"><img
                                                        src="<?php echo base_url('assets/images/media/bg-img1.jpg'); ?>" alt="Bg-Image" id="bgimage1"></a>
                                                <a class="bg-img2" href="javascript:void(0);" onclick="bgImage(this)"><img
                                                        src="<?php echo base_url('assets/images/media/bg-img2.jpg'); ?>" alt="Bg-Image" id="bgimage2"></a>
                                                <a class="bg-img3" href="javascript:void(0);" onclick="bgImage(this)"><img
                                                        src="<?php echo base_url('assets/images/media/bg-img3.jpg'); ?>" alt="Bg-Image" id="bgimage3"></a>
                                                <a class="bg-img4" href="javascript:void(0);" onclick="bgImage(this)"><img
                                                        src="<?php echo base_url('assets/images/media/bg-img4.jpg'); ?>" alt="Bg-Image" id="bgimage4"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
