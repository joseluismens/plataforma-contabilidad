											...
											<div class="row">
												<div class="col-xl-8">
													<div class="">
														<div class="d-sm-flex d-block align-items-center">
															<div class="d-flex align-items-center mb-sm-0 mb-2">
																...
																<a href="javascript:void(0)" class="avatar avatar-sm rounded-circle cover-image" data-bs-image-src= "<?php echo base_url('assets/images/users/4.jpg'); ?>"></a>
																</div>
													...
													<div class="ps-relative p-1 bg-light br-5">
														<img src="<?php echo base_url('assets/images/photos/blogmain2.jpg'); ?>" alt="img" class="cover-image br-5 ms-auto me-auto wp-100">
													...
													<div class="mt-4 pt-5 border-top">
														...
														<div class="media mb-4 overflow-visible">
															<div class="me-3">
																<a href="<?php echo base_url('profile'); ?>"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="<?php echo base_url('assets/images/users/5.jpg'); ?>"> </a>
															</div>
															<div class="media-body overflow-visible">
																...
																<div class="media mb-4 overflow-visible">
																	<div class="me-3">
																		<a href="<?php echo base_url('profile'); ?>"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="<?php echo base_url('assets/images/users/2.jpg'); ?>"> </a>
																	</div>
														...
														<div class="media mb-4 overflow-visible">
															<div class="me-3">
																<a href="<?php echo base_url('profile'); ?>"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="<?php echo base_url('assets/images/users/15.jpg'); ?>"> </a>
															</div>
															<div class="media-body overflow-visible">
																<div class="border mb-5 p-4 br-5">
																	<nav class="nav float-end">
													...
													<div class="card overflow-hidden border br-5">
														...
														<div class="card-body">
															<div class="text-center">
																<a href="<?php echo base_url('blog-details'); ?>"><img class="card-img-top w-100 w-100" src="<?php echo base_url('assets/images/photos/11.jpg'); ?>" alt=""></a>
															...
															<div class="item-list">
																<ul class="list-group mb-0">
																	<li class="list-group-item d-flex pb-4 pt-0 px-0 border-bottom-0">
																		<img src="<?php echo base_url('assets/images/photos/blog-sm1.jpg'); ?>" class="avatar br-5 avatar-lg me-3 my-auto" alt="avatar-img">
																		<div>
																	...
																	<li class="list-group-item d-flex pb-4 pt-0 px-0 border-bottom-0">
																		<img src="<?php echo base_url('assets/images/photos/blog-sm2.jpg'); ?>" class="avatar br-5 avatar-lg me-3 my-auto" alt="avatar-img">
																		<div>
																	...
																	<li class="list-group-item d-flex pb-4 pt-0 px-0 border-bottom-0">
																		<img src="<?php echo base_url('assets/images/photos/blog-sm3.jpg'); ?>" class="avatar br-5 avatar-lg me-3 my-auto" alt="avatar-img">
																		<div>
																	...
																	<li class="list-group-item d-flex pb-4 pt-0 px-0 border-bottom-0">
																		<img src="<?php echo base_url('assets/images/photos/blog-sm4.jpg'); ?>" class="avatar br-5 avatar-lg me-3 my-auto" alt="avatar-img">
																		<div>
															...
															<div class="text-center demo-gallery">
																<div class="mt-2">
																	<ul id="lightgallery" class="list-unstyled row row-sm">
																		<li class="col-sm-6 col-lg-4" data-responsive="<?php echo base_url('assets/images/photos/blog2.jpg'); ?>" data-src="<?php echo base_url('assets/images/photos/blog2.jpg'); ?>" data-sub-html="<h4>Gallery Image 1</h4>">
																			<a href="javascript:void(0)">
																				<img class="img-responsive br-5 w-100" src="<?php echo base_url('assets/images/photos/blog2.jpg'); ?>" alt="Thumb-1">
																			</a>
																		</li>
																		<li class="col-sm-6 col-lg-4" data-responsive="<?php echo base_url('assets/images/photos/fileimage1.jpg'); ?>" data-src="<?php echo base_url('assets/images/photos/fileimage1.jpg'); ?>" data-sub-html="<h4>Gallery Image 2</h4>">
																			<a href="javascript:void(0)">
																				<img class="img-responsive br-5 w-100" src="<?php echo base_url('assets/images/photos/fileimage1.jpg'); ?>" alt="Thumb-1">
																			</a>
																		</li>
																		<li class="col-sm-6 col-lg-4" data-responsive="<?php echo base_url('assets/images/photos/fileimage3.jpg'); ?>" data-src="<?php echo base_url('assets/images/photos/fileimage3.jpg'); ?>" data-sub-html="<h4>Gallery Image 3</h4>">
																			<a href="javascript:void(0)">
																				<img class="img-responsive br-5 w-100" src="<?php echo base_url('assets/images/photos/fileimage3.jpg'); ?>" alt="Thumb-1">
																			</a>
																		</li>
																		<li class="col-sm-6 col-lg-4" data-responsive="<?php echo base_url('assets/images/photos/fileimage2.jpg'); ?>" data-src="<?php echo base_url('assets/images/photos/fileimage2.jpg'); ?>" data-sub-html="<h4>Gallery Image 4</h4>">
																			<a href="javascript:void(0)">
																				<img class="img-responsive br-5 w-100" src="<?php echo base_url('assets/images/photos/fileimage2.jpg'); ?>" alt="Thumb-1">
																			</a>
																		</li>
																		<li class="col-sm-6 col-lg-4" data-responsive="<?php echo base_url('assets/images/photos/blog2.jpg'); ?>" data-src="<?php echo base_url('assets/images/photos/blog2.jpg'); ?>" data-sub-html="<h4>Gallery Image 5</h4>">
																			<a href="javascript:void(0)">
																				<img class="img-responsive br-5 w-100" src="<?php echo base_url('assets/images/photos/blog2.jpg'); ?>" alt="Thumb-1">
																			</a>
																		</li>
																		<li class="col-sm-6 col-lg-4" data-responsive="<?php echo base_url('assets/images/photos/fileimage4.jpg'); ?>" data-src="<?php echo base_url('assets/images/photos/fileimage4.jpg'); ?>" data-sub-html="<h4>Gallery Image 6</h4>">
																			<a href="javascript:void(0)">
																				<img class="img-responsive br-5 w-100" src="<?php echo base_url('assets/images/photos/fileimage4.jpg'); ?>" alt="Thumb-1">
																			</a>
																		</li>
																		<li class="col-sm-6 col-lg-4" data-responsive="<?php echo base_url('assets/images/photos/fileimage1.jpg'); ?>" data-src="<?php echo base_url('assets/images/photos/fileimage1.jpg'); ?>" data-sub-html="<h4>Gallery Image 7</h4>">
																			<a href="javascript:void(0)">
																				<img class="img-responsive br-5 w-100" src="<?php echo base_url('assets/images/photos/fileimage1.jpg'); ?>" alt="Thumb-1">
																			</a>
																		</li>
																		<li class="col-sm-6 col-lg-4" data-responsive="<?php echo base_url('assets/images/photos/fileimage2.jpg'); ?>" data-src="<?php echo base_url('assets/images/photos/fileimage2.jpg'); ?>" data-sub-html="<h4>Gallery Image 8</h4>">
																			<a href="javascript:void(0)">
																				<img class="img-responsive br-5 w-100" src="<?php echo base_url('assets/images/photos/fileimage2.jpg'); ?>" alt="Thumb-1">
																			</a>
																		</li>
																		<li class="col-sm-6 col-lg-4" data-responsive="<?php echo base_url('assets/images/photos/fileimage3.jpg'); ?>" data-src="<?php echo base_url('assets/images/photos/fileimage3.jpg'); ?>" data-sub-html="<h4>Gallery Image 9</h4>">
																			<a href="javascript:void(0)">
																				<img class="img-responsive br-5 w-100" src="<?php echo base_url('assets/images/photos/fileimage3.jpg'); ?>" alt="Thumb-1">
																			</a>
																		</li>
