							...
							<div class="row row-cards">
								...
								<div class="col-xl-9 col-lg-12">
									...
									<div class="row products-main">
										<div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3" id="product-each">
											<div class="card item-card">
												<div class="product-grid6 card-body">
													<div class="product-image6">
														<a href="<?php echo base_url('product-details'); ?>" class="img-container">
															<img class="img-fluid" src="<?php echo base_url('assets/images/pngs/4.png'); ?>" alt="img">
														</a>
														<div class="icon-container">
															<ul class="icons">
																<li>
																	<a href="<?php echo base_url('product-details'); ?>" data-tip="Quick View">
																...
																<li>
																	<a href="<?php echo base_url('wishlist'); ?>" data-tip="Add to Wishlist">
																...
																<li>
																	<a href="<?php echo base_url('cart'); ?>" data-tip="Add to Cart">
										...
										<div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3" id="product-each1">
											<div class="card item-card">
												<div class="product-grid6 card-body">
													<div class="product-image6">
														<a href="<?php echo base_url('product-details'); ?>" class="img-container">
															<img class="img-fluid" src="<?php echo base_url('assets/images/pngs/6.png'); ?>" alt="img">
														</a>
														<div class="icon-container">
															<ul class="icons">
																<li>
										...
										<div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3" id="product-each2">
											<div class="card item-card">
												<div class="product-grid6 card-body">
													<div class="product-image6">
														<a href="<?php echo base_url('product-details'); ?>" class="img-container">
															<img class="img-fluid" src="<?php echo base_url('assets/images/pngs/10.png'); ?>" alt="img">
														</a>
														<div class="icon-container">
															<ul class="icons">
																<li>
										...
										<div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3" id="product-each3">
											<div class="card item-card">
												<div class="product-grid6 card-body">
													<div class="product-image6">
														<a href="<?php echo base_url('product-details'); ?>" class="img-container">
															<img class="img-fluid" src="<?php echo base_url('assets/images/pngs/2.png'); ?>" alt="img">
														</a>
														<div class="icon-container">
															<ul class="icons">
																<li>
										...
										<div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3" id="product-each4">
											<div class="card item-card">
												<div class="product-grid6 card-body">
													<div class="product-image6">
														<a href="<?php echo base_url('product-details'); ?>" class="img-container">
															<img class="img-fluid" src="<?php echo base_url('assets/images/pngs/8.png'); ?>" alt="img">
														</a>
														<div class="icon-container">
															<ul class="icons">
																<li>
										...
										<div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3" id="product-each5">
											<div class="card item-card">
												<div class="product-grid6 card-body">
													<div class="product-image6">
														<a href="<?php echo base_url('product-details'); ?>" class="img-container">
															<img class="img-fluid" src="<?php echo base_url('assets/images/pngs/5.png'); ?>" alt="img">
														</a>
														<div class="icon-container">
															<ul class="icons">
																<li>
										...
										<div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3" id="product-each6">
											<div class="card item-card">
												<div class="product-grid6 card-body">
													<div class="product-image6">
														<a href="<?php echo base_url('product-details'); ?>" class="img-container">
															<img class="img-fluid" src="<?php echo base_url('assets/images/pngs/3.png'); ?>" alt="img">
														</a>
														<div class="icon-container">
															<ul class="icons">
																<li>
										...
										<div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3" id="product-each7">
											<div class="card item-card">
												<div class="product-grid6 card-body">
													<div class="product-image6">
														<a href="<?php echo base_url('product-details'); ?>" class="img-container">
															<img class="img-fluid" src="<?php echo base_url('assets/images/pngs/9.png'); ?>" alt="img">
														</a>
														<div class="icon-container">
															<ul class="icons">
																<li>
										...
										<div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3" id="product-each8">
											<div class="card item-card">
												<div class="product-grid6 card-body">
													<div class="product-image6">
														<a href="<?php echo base_url('product-details'); ?>" class="img-container">
															<img class="img-fluid" src="<?php echo base_url('assets/images/pngs/1.png'); ?>" alt="img">
														</a>
														<div class="icon-container">
															<ul class="icons">
																<li>
