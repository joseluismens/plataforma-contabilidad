																		...
																		<div class="switch-toggle">
																			...
																			<div class="d-flex mt-2">
																				<a class="bg-img1 me-2" href="javascript:void(0);" onclick="bgImage(this)"><img
																						class="br-5" src="<?php echo base_url('assets/images/media/bg-img1.jpg'); ?>" alt="Bg-Image" id="bgimage1"></a>
																				<a class="bg-img2 me-2" href="javascript:void(0);" onclick="bgImage(this)"><img
																						class="br-5" src="<?php echo base_url('assets/images/media/bg-img2.jpg'); ?>" alt="Bg-Image" id="bgimage2"></a>
																				<a class="bg-img3 me-2" href="javascript:void(0);" onclick="bgImage(this)"><img
																						class="br-5" src="<?php echo base_url('assets/images/media/bg-img3.jpg'); ?>" alt="Bg-Image" id="bgimage3"></a>
																				<a class="bg-img4 me-2" href="javascript:void(0);" onclick="bgImage(this)"><img
																						class="br-5" src="<?php echo base_url('assets/images/media/bg-img4.jpg'); ?>" alt="Bg-Image" id="bgimage4"></a>
																			</div>
																		</div>
																	</div>
																</div>
