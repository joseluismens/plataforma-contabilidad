										...
										<div class="card-body">
											<div class="row align-items-center">
												<div class="col-xl col-lg-6 col-md-12">
													<div class="btn-list">
														<a href="<?php echo base_url('client-create'); ?>" class="btn btn-primary">
										...
										<div class="card-body">
											<div class="client-title mt-0">
												<figure class="rounded-circle align-self-start mb-0">
													<img src="<?php echo base_url('assets/images/users/16.jpg'); ?>" alt="Generic placeholder image" class="avatar brround avatar-lg me-3">
												</figure>
								...
								<div class="col-lg-6 col-md-12 col-xl-4 col-sm-12">
									<div class="card mb-5">
										<div class="card-body">
											<div class="client-title mt-0">
												<figure class="rounded-circle align-self-start mb-0">
													<img src="<?php echo base_url('assets/images/users/1.jpg'); ?>" alt="Generic placeholder image" class="avatar brround avatar-lg me-3">
												</figure>
												<div class="media-body">
								...
								<div class="col-lg-6 col-md-12 col-xl-4 col-sm-12">
									<div class="card mb-5">
										<div class="card-body">
											<div class="client-title mt-0">
												<figure class="rounded-circle align-self-start mb-0">
													<img src="<?php echo base_url('assets/images/users/2.jpg'); ?>" alt="Generic placeholder image" class="avatar brround avatar-lg me-3">
												</figure>
												<div class="media-body">
								...
								<div class="col-lg-6 col-md-12 col-xl-4 col-sm-12">
									<div class="card mb-5">
										<div class="card-body">
											<div class="client-title mt-0">
												<figure class="rounded-circle align-self-start mb-0">
													<img src="<?php echo base_url('assets/images/users/15.jpg'); ?>" alt="Generic placeholder image" class="avatar brround avatar-lg me-3">
												</figure>
												<div class="media-body">
								...
								<div class="col-lg-6 col-md-12 col-xl-4 col-sm-12">
									<div class="card mb-5">
										<div class="card-body">
											<div class="client-title mt-0">
												<figure class="rounded-circle align-self-start mb-0">
													<img src="<?php echo base_url('assets/images/users/3.jpg'); ?>" alt="Generic placeholder image" class="avatar brround avatar-lg me-3">
												</figure>
												<div class="media-body">
								...
								<div class="col-lg-6 col-md-12 col-xl-4 col-sm-12">
									<div class="card mb-5">
										<div class="card-body">
											<div class="client-title mt-0">
												<figure class="rounded-circle align-self-start mb-0">
													<img src="<?php echo base_url('assets/images/users/5.jpg'); ?>" alt="Generic placeholder image" class="avatar brround avatar-lg me-3">
												</figure>
												<div class="media-body">
